...
describe('SidePanel workspace controls and retained browser-tab frame', () => {
  it('keeps the browser-tab strip on the aligned half-card header', () => {
    ...
    expect(strip.querySelector('[data-panel-controls-region="panel-shape"]')).not.toBeNull()
    expect(strip.querySelector('[data-panel-controls-region="workspace-visibility"]')).not.toBeNull()
  ...
  it('separates panel-shape actions from workspace visibility toggles', () => {
    ...
    const shapeRegion = fullscreen.closest('[data-panel-controls-region="panel-shape"]') as HTMLElement
    const visibilityRegion = terminal.closest('[data-panel-controls-region="workspace-visibility"]') as HTMLElement
